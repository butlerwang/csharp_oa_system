<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SettingConfig.aspx.cs" Inherits="OA.aspx.BBS.SettingConfig" %>
<html>
	<head>
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="简要介绍">
                            <ItemTemplate>
                                &nbsp;<asp:HyperLink ID="HyperLink1" NavigateUrl='<%# "BanKuaiView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID") %>' runat="server" Font-Bold="True" Font-Underline="False" ForeColor="green"><%#DataBinder.Eval(Container.DataItem, "BanKuaiName")%></asp:HyperLink><br />
