<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RedHeadFile.aspx.cs" Inherits="OA.aspx.SystemManage.RedHeadFile" %>
<html>
	<head>
                        ...
                        <asp:TemplateField HeaderText="红头文件">
                            <ItemTemplate>
                                ...
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green"
                                    NavigateUrl='<%# "../../UploadFile/" + DataBinder.Eval(Container.DataItem, "FilePath") %>'  >[打开文件]</asp:HyperLink>
                            </ItemTemplate>
