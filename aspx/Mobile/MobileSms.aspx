<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MobileSms.aspx.cs" Inherits="OA.aspx.Mobile.MobileSms" %>
...
<asp:Button ID="iButton5" runat="server" CssClass="btn btn-green" Text="发送" OnClick="iButton5_Click" OnClientClick="javascript:return CheckModify();"  />
                    &nbsp;
<asp:Button ID="iButton3" runat="server" OnClientClick="javascript:return CheckDel();" CssClass="btn btn-red" Text="删除" OnClick="iButton3_Click" />
                    &nbsp;
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button>&nbsp;
                </td>
            </tr>
        </table>
