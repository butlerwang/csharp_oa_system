<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubRiCheng.aspx.cs" Inherits="OA.aspx.Moa.Subaltern.SubRiCheng" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style=" height: 30px;">
                    主题：<asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="65px"></asp:TextBox>
                    用户名：<asp:TextBox ID="TextBox2" runat="server" Height="30px" Width="65px"></asp:TextBox><img
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <HeaderStyle BackColor="#006599" Font-Size="12px" ForeColor="White" Height="30px" /><AlternatingRowStyle BackColor="#f9f9f7" />
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
