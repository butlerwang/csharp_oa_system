<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BanKuaiView.aspx.cs" Inherits="OA.aspx.BBS.BanKuaiView" %>
<html>
	<head>
...
<asp:ImageButton ID="iButton6" runat="server" ImageUrl="../../images/Button/Ding.jpg" ImageAlign="AbsMiddle" OnClick="iButton6_Click" />&nbsp;
                    
<asp:ImageButton ID="iButton7" runat="server" ImageUrl="../../images/Button/QuDing.jpg" ImageAlign="AbsMiddle" OnClick="iButton7_Click" />
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="帖子主题">
                            <ItemTemplate>                                
                                &nbsp;<img src="../../images/child.gif" align="absMiddle" />&nbsp;<asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green"
