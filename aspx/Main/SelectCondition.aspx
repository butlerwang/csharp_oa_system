<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectCondition.aspx.cs" Inherits="OA.aspx.Main.SelectCondition" %>
	...
	<body scroll="no">
		<form id="Form1" method="post" runat="server">
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
				...
				<tr>
			    <td valign="top" style="text-align: center">				  查询：<asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="100px"></asp:TextBox>
