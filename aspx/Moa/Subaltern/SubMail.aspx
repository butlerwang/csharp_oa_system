<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubMail.aspx.cs" Inherits="OA.aspx.Moa.Subaltern.SubMail" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style=" height: 30px;">
                    主题：<asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="60px"></asp:TextBox>
                    用户：<asp:TextBox
                    ...
                    状态：<asp:TextBox ID="TextBox3" runat="server" Height="30px" Width="60px"></asp:TextBox><img
