<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NWorkFlow.aspx.cs" Inherits="OA.aspx.NWorkFlow.NWorkFlow" %>
<html>
	<head>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="流程名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "NWorkFlowView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "WorkFlowName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					...
					<asp:TemplateField HeaderText="相关操作"><ItemTemplate>
                        ...
                        <asp:HyperLink ID="HyperLink10" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "NWorkFlowNode.aspx?FormID="+DataBinder.Eval(Container.DataItem, "FormID")+"&WorkFlowID="+ DataBinder.Eval(Container.DataItem, "ID") %>' >[节点定义]</asp:HyperLink>
                        <asp:HyperLink ID="HyperLink11" runat="server" Font-Underline="False" ForeColor="green" Target="_blank" NavigateUrl='<%# "NWorkFlowReView.aspx?FormID="+DataBinder.Eval(Container.DataItem, "FormID")+"&WorkFlowID="+ DataBinder.Eval(Container.DataItem, "ID") %>' >[流程预览]</asp:HyperLink>
