<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LanEmailShou.aspx.cs" Inherits="OA.aspx.LanEmail.LanEmailShou" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style=" height: 30px;">
                    主题：<asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="60px"></asp:TextBox>发送人：<asp:TextBox
                        ID="TextBox2" runat="server" Height="30px" Width="60px"></asp:TextBox><img class="HerCss"
                            ...
                            src="../../images/Button/search.gif" />状态：<asp:TextBox ID="TextBox3" runat="server" Height="30px" Width="60px"></asp:TextBox><img
