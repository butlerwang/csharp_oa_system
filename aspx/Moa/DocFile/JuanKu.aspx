<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JuanKu.aspx.cs" Inherits="OA.aspx.Moa.DocFile.JuanKu" %>
<html>
	<head>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="卷库名称"> <ItemTemplate><img src="../../images/filetype/dir.gif" style="vertical-align: middle" /> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "JuanKuView.aspx?JuanKuName="+DataBinder.Eval(Container.DataItem, "JuanKuName")+"&ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "JuanKuName")%></asp:HyperLink> 
					
					
                        <asp:HyperLink ID="HyperLink2" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "DangAn.aspx?JuanKuName="+DataBinder.Eval(Container.DataItem, "JuanKuName") %>'>[打开卷库]</asp:HyperLink>
