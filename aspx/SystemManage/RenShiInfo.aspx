<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RenShiInfo.aspx.cs" Inherits="OA.aspx.SystemManage.RenShiInfo" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style=" height: 30px;">
                    ...
                    姓名：<asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="60px"></asp:TextBox>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="姓名">
                            <ItemTemplate>
                                ...
                                <asp:HyperLink ID="HyperLink11" runat="server" Font-Underline="False" ForeColor="green"
