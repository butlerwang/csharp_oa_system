<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyCustomService.aspx.cs" Inherits="OA.aspx.CRM.MyCustomService" %>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <tr>
            <td style="border-top: #eeeeee 1px solid;border-bottom: #eeeeee 1px solid">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<img src="../../images/TreeImages/test.gif" align="absMiddle" /><asp:HyperLink ID="HyperLink2" runat="server" Font-Bold="True" Font-Underline="False" ForeColor="green"
                    NavigateUrl="~/CRM/CustomService.aspx?Type=Share">查看共享业务数据</asp:HyperLink></td>
        </tr>
        </table>
    </form>
</body>
