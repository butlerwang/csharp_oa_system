<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RiCheng.aspx.cs" Inherits="OA.aspx.Work.RiCheng" %>
<html>
	<head>
...
<asp:Button ID="iButton4" runat="server" CssClass="btn btn-blue" Text="查询" OnClick="iButton4_Click" />&nbsp;<asp:LinkButton ID="LinkButton1" runat="server"
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="主题">
                            <ItemTemplate><asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green"
        ...
        <asp:Panel ID="Panel2" runat="server" Width="100%">
            <br />
        <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="Green"
                                CellPadding="4" FirstDayOfWeek="Monday" ForeColor="blue" Height="320px" NextPrevFormat="ShortMonth"
                                ...
                                <DayHeaderStyle BackColor="#f9f9f7" BorderWidth="1px" Font-Size="12px" />
                                <TitleStyle BorderWidth="1px" BackColor="#f9f9f7" />
