<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerchWorkFlow.aspx.cs" Inherits="OA.aspx.NWorkFlow.SerchWorkFlow" %>
<html>
	<head>
...
<asp:Button ID="iButton5" runat="server" CssClass="btn btn-blue" Text="抄送" OnClick="iButton5_Click" OnClientClick="javascript:return CheckModify();"  />&nbsp;
