<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyCustomLinkLog.aspx.cs" Inherits="OA.aspx.CRM.MyCustomLinkLog" %>
        ...
        <tr>
            <td style="border-top: #eeeeee 1px solid;border-bottom: #eeeeee 1px solid">
                ...
                <img align="absMiddle" src="../../images/TreeImages/test.gif" /><asp:HyperLink ID="HyperLink2"
                    runat="server" Font-Bold="True" Font-Underline="False" ForeColor="green" NavigateUrl="~/CRM/CustomLinkLog.aspx?Type=Share">查看共享业务数据</asp:HyperLink></td>
        </tr>
        </table>
    </form>
</body>
