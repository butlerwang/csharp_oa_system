<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectYinZhang.aspx.cs" Inherits="OA.aspx.Moa.Main.SelectYinZhang" %>
		...
		<form id="Form1" method="post" runat="server">
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
			    ...
			    <td valign="top" style="text-align: center">				  
                    ...
                    <tr>
                        <td colspan="2" style="height: 31px; text-align: left;">
                            &nbsp; 印章密码：<asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="200px"></asp:TextBox></td>
                    </tr>
                      <tr>
