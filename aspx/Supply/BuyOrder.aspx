<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyOrder.aspx.cs" Inherits="OA.aspx.Supply.BuyOrder" %>
...
<asp:Button ID="iButton1" runat="server" OnClientClick="javascript:return CheckDel1();" CssClass="btn btn-purple" Text="通过" OnClick="iButton1_Click" /></asp:ImageButton>&nbsp;
<asp:Button ID="iButton5" runat="server" CssClass="btn btn-red" Text="拒绝" OnClick="iButton5_Click" OnClientClick="javascript:return CheckDel();"/></asp:ImageButton>
