<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FK.aspx.cs" Inherits="OA.aspx.Supply.FK" %>
                ...
                <asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="订单名称">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "FKView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "HeTongName")%></asp:HyperLink>
                            </ItemTemplate>
