<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reimburse.aspx.cs" Inherits="OA.aspx.Financial.Reimburse" %>
                ...
                <asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="报销内容">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "ReimburseView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "ReimburseContent")%></asp:HyperLink>
                            </ItemTemplate>
