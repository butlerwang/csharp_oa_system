<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TiKuKaoShiAdd.aspx.cs" Inherits="OA.aspx.Moa.DocFile.TiKuKaoShiAdd" %>
...
<asp:Button ID="iButton1" runat="server" CssClass="btn btn-blue" Text="提交" OnClick="iButton1_Click" />
        ...
        <table style="width: 100%" bgcolor="#999999" class="gridview_m" border="0" cellpadding="2" cellspacing="1">
            <tr>
                <td style="width: 10%; height: 25px; background-color: #f9f9f7" align="right">
                    请选择试卷：
                </td>
