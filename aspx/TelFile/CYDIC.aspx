<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CYDIC.aspx.cs" Inherits="OA.aspx.TelFile.CYDIC" %>
<html>
	<head>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="文件夹名称"> <ItemTemplate> <img src="../../images/filetype/dir.gif" /> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "SendFile.aspx?DicID="+ DataBinder.Eval(Container.DataItem, "ID")+"&DicName="+ DataBinder.Eval(Container.DataItem, "DicName")%>'><%# DataBinder.Eval(Container.DataItem, "DicName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
