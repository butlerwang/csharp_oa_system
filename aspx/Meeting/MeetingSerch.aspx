<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeetingSerch.aspx.cs" Inherits="OA.aspx.Meeting.MeetingSerch" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style=" height: 30px;">
                    标题：<asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="60px"></asp:TextBox>
                    主持人：<asp:TextBox ID="TextBox2" runat="server" Height="30px" Width="60px"></asp:TextBox>
