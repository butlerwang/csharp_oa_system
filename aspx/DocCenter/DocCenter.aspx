<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocCenter.aspx.cs" Inherits="OA.aspx.DocCenter.DocCenter" %>
<html>
	<head>
...
<asp:Button ID="iButton6" runat="server" CssClass="btn btn-blue" Text="新建目录" OnClick="iButton6_Click" />&nbsp;
