<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocHuiShou.aspx.cs" Inherits="OA.aspx.Moa.DocCenter.DocHuiShou" %>
<html>
	<head>
...
<asp:Button ID="iButton3" runat="server" OnClientClick="javascript:return CheckDel();" CssClass="btn btn-red" Text="删除" OnClick="iButton3_Click" />
                    &nbsp;
<asp:Button ID="iButton1" runat="server" OnClientClick="javascript:return CheckHuiFu();" CssClass="btn btn-aqua" Text="恢复" OnClick="iButton1_Click" />
                    &nbsp;
