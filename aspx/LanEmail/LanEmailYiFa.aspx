<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LanEmailYiFa.aspx.cs" Inherits="OA.aspx.LanEmail.LanEmailYiFa" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style=" height: 30px;">
                    主题：<asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="60px"></asp:TextBox>接收人：<asp:TextBox
