<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LanEmailCao.aspx.cs" Inherits="OA.aspx.LanEmail.LanEmailCao" %>
<html>
	<head>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-green" Text="发送" OnClick="iButton2_Click" OnClientClick="javascript:return CheckModify();"/>&nbsp;
...
<asp:Button ID="iButton5" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton5_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
            </tr>
        </table>
