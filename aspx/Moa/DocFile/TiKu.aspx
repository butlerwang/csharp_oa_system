<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TiKu.aspx.cs" Inherits="OA.aspx.Moa.DocFile.TiKu" %>
<html>
	<head>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="题目标题"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "TiKuView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")+"&TiKuID="+ DataBinder.Eval(Container.DataItem, "TiKuID")+"&FenLeiStr="+ DataBinder.Eval(Container.DataItem, "FenLeiStr")%>'><%# DataBinder.Eval(Container.DataItem, "TitleStr")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" Width="400px" />  </asp:TemplateField> 
