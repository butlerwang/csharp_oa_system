<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemUserSerch.aspx.cs" Inherits="OA.aspx.SystemManage.SystemUserSerch" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style=" height: 30px;">
                    部门：<asp:TextBox ID="TextBox2" runat="server" Height="30px" Width="60px"></asp:TextBox><img
                    ...
                    用户名：<asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="60px"></asp:TextBox>
<asp:Button ID="iButton4" runat="server" CssClass="btn btn-blue" Text="查询" OnClick="iButton4_Click" />&nbsp;&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
            </tr>
        </table>
