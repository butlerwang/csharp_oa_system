<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaoXiaoGuanLi.aspx.cs" Inherits="OA.aspx.Project.BaoXiaoGuanLi" %>
<html>
	<head>
...
<asp:Button ID="iButton1" runat="server" OnClientClick="javascript:return CheckDel1();" CssClass="btn btn-purple" Text="通过" OnClick="iButton1_Click" />&nbsp;
                    &nbsp;
                    
<asp:Button ID="iButton3" runat="server" OnClientClick="javascript:return CheckDel();" CssClass="btn btn-red" Text="拒绝" OnClick="iButton3_Click" />&nbsp;
                    &nbsp;
