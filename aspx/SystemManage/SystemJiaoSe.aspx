<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemJiaoSe.aspx.cs" Inherits="OA.aspx.SystemManage.SystemJiaoSe" %>
<html>
	<head>
                        ...
                        <asp:TemplateField HeaderText="角色名称">
                            <ItemTemplate>
                                ...
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green"
                                    ...
                                    <asp:HyperLink ID="HyperLink2" runat="server" Font-Underline="False" ForeColor="green"  
