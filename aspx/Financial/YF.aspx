<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YF.aspx.cs" Inherits="OA.aspx.Financial.YF" %>
                ...
                <asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="合同名称">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "YFView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "HeTongName")%></asp:HyperLink>
                            </ItemTemplate>
