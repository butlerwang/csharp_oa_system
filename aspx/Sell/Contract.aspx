<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contract.aspx.cs" Inherits="OA.aspx.Sell.Contract" %>
...
<asp:Button ID="iButton5" runat="server" CssClass="btn btn-red" Text="拒绝" OnClick="iButton5_Click" OnClientClick="javascript:return CheckDel1();"/></asp:ImageButton>
