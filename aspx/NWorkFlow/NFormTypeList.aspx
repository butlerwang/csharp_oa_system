<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NFormTypeList.aspx.cs" Inherits="OA.aspx.NWorkFlow.NFormTypeList" %>
<html>
	<head>
     ...
     <table style="width: 100%; height:100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;流程表单
                    ...
                    <tr>
            <td style="background-color:#f9f9f7; vertical-align:top; padding-top:10px;">
